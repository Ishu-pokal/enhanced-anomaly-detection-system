...
git clone https://github.com/ishupokal/anomaly-detection-system.git
...
- Project Link: https://github.com/ishupokal/anomaly-detection-system
- Email: ishupokal077@gmail.com
- Issues: Report bugs and feature requests via the GitHub issues tab
...
@misc{anomaly_detection_2025,
  ...
  author={Isita Pokal},
  year={2025},
  url={https://github.com/ishupokal/anomaly-detection-system}
}
```
...
Isita Pokal is a Supply Chain Analyst with over 4 years of experience in data-driven optimization and process improvement. This project reflects an ongoing commitment to leveraging advanced analytics and deep learning to solve complex operational and security challenges in modern network environments.
